...
public class LeaveController {
    ...
    @ResponseBody
    public ResponseEntity<CommonResult<CalendarResult>> getAlarmList(@AuthenticationPrincipal UserEntity loginUser) {
        CalendarResult result = leaveService.getCalendarData(loginUser.getEmpId());
